...
//+kubebuilder:rbac:groups=module.x-helm.dev,resources=actions,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=module.x-helm.dev,resources=actions/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=module.x-helm.dev,resources=actions/finalizers,verbs=update
